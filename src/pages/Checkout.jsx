...
const Checkout = () => {
  ...
  return (
    ...
    <section id="left">
      <div id="head">
        <h1>{state.message.name}</h1>
        <p>{state.message.color + ' ' + state.message.material}</p>
        <img src={state.message.image} alt="" />
      </div>
      <h3>Only {state.message.price}$</h3>
    </section>
    <section id="right">
      <h1>Purchase</h1>
      <form action="#">
        <div id="form-card" class="form-field">
          <label for="cc-number">Card holder name:</label>
